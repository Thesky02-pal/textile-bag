...
var map = new mapboxgl.Map({
 container: 'map',
 style: 'mapbox://styles/satmace/clh7geyae00tk01pn2odhglhg',
 ...
 style: 'mapbox://styles/satmace/clh7geyae00tk01pn2odhglhg',
    ...
    //  zoom: 4,
     ...
     const markerCoords1 = [
          ...
          [75.56835,20.99685],   //added
          // [72.7474142, 21.1924098],    //added
          // [72.8199922, 22.1924882],   //comment
              // Add
          // [72.7474142,  20.1924098],
          // [73.856255, 18.516726],
          // [74.576782, 18.150663],
          // [72.911453,  22.385181],  // comment
          // [73.911453,  19.385181],
          [73.911453,  19.385181],
          [73.911453,  19.395181] //added
        ];
        const markers1 = markerCoords1.map((coord, index) => {
          const color = (index === 3) ? '#55d5a5' : '#9b9b9b';   //change 1 to 3  again 1 to2
          ...
          features: [
            {
              ...
              geometry: {
                type: 'LineString',
                coordinates: markerCoords1.slice(0, 3)   //change 1 to 3 again 2
              },
              properties: {
            ...
            },
            {
              ...
              geometry: {
                type: 'LineString',
                coordinates: [markerCoords1[0], markerCoords1[2]] ,  //2 and 3
                coordinates: [markerCoords1[0], markerCoords1[3]]    //added
              }, 
              properties: {
                'stroke': '#55d5a5',       //
                'stroke-width': 3
...
const markers2 = markerCoords2.map((coord, index) => {
     const color = (index ===2 ) ? '#55d5a5' : '#9b9b9b';  // change 4 to 2
     return new mapboxgl.Marker({ color })
       .setLngLat(coord)
       .addTo(map3);
   });
   ...
   const featureCollection2 = {
     ...
     features: [
       ...
       },
       {
         ...
         geometry: {
           type: 'LineString',
           coordinates: [markerCoords2[1], markerCoords2[2]]   //4 and 0
         },
         properties: {
           'stroke': '#55d5a5',
           'stroke-width': 3
...
const markers3 = markerCoords3.map((coord, index) => {
     const color = (index === 3) ? '#55d5a5' : '#9b9b9b';   //chnage 5 to 3
     return new mapboxgl.Marker({ color })
       .setLngLat(coord)
       .addTo(map4);
   });
     ...
     features: [
       {
         ...
         geometry: {
           type: 'LineString',
           coordinates: markerCoords3.slice(0, 3)     //chnage 5 to 3
         },
         properties: {
           'stroke': '#9b9b9b',
           'stroke-width': 3
